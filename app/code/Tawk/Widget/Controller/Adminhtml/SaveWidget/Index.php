...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $pageId = filter_var($this->request->getParam('pageId'), FILTER_SANITIZE_FULL_SPECIAL_CHARS);
        $widgetId = filter_var($this->request->getParam('widgetId'), FILTER_SANITIZE_FULL_SPECIAL_CHARS);
        $storeId = filter_var($this->request->getParam('id'), FILTER_SANITIZE_FULL_SPECIAL_CHARS);
        ...
        $excludeurl = filter_var($this->request->getParam('excludeurl'), FILTER_SANITIZE_FULL_SPECIAL_CHARS);
        $donotdisplay = filter_var($this->request->getParam('donotdisplay'), FILTER_SANITIZE_NUMBER_INT);
        $includeurl = filter_var($this->request->getParam('includeurl'), FILTER_SANITIZE_FULL_SPECIAL_CHARS);
